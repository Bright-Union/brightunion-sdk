...
export declare function buyCoverNexus(_ownerAddress: string, _distributorName: string, _contractAddress: string, _coverAsset: string, _sumAssured: number, _amountOut: number, _coverPeriod: number, _coverType: any, _maxPriceWithFee: number, buyingWithNetworkCurrency: boolean, _quoteProtocol: any): Promise<unknown>;
