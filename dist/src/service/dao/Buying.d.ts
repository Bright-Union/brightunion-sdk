...
export declare function buyCoverNexus(_ownerAddress: string, _distributorName: string, _coverAsset: string, _sumAssured: number, _amountOut: number, _priceWithSlippage: number, _coverPeriod: number, _maxPriceWithFee: number, buyingWithNetworkCurrency: boolean, _quoteProtocol: any): Promise<unknown>;
