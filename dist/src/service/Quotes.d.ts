...
export declare function getQuoteFrom(_distributorName: string, _amount: number, _currency: string, _period: number, _protocol: any, _net: any, _owner: string): Promise<object>;
export declare function getNexusQuote(_amount: any, _currency: any, _period: any, _protocol: any): Promise<object>;
export declare function getInsuraceQuote(_web3: any, _amount: any, _currency: any, _period: any, _protocol: any, _owner: any): Promise<object>;
