...
//     it('Should have.property(price)', async () => {
...
//       expect(bridgeQuote).to.have.property('price')
//     });
//   });
...
//                     let spender = bridgeQuote.protocol.bridgeProductAddress;
...
//                            console.log('// Signing tx manually...');
...
//                             )
//                         }, async() => { console.log(Error);  }  //onError
//                     );
//               }
